...
export function createInstance (
  ...
  // Each instance has a independent `Vue_router` module instance
  const Vue = instance.Vue = createVueModuleInstance(instanceId, moduleGetter)

  // The function which create a closure the JS Bundle will run in.
  // It will declare some instance variables like `Vue_router`, HTML5 Timer APIs etc.
 ...
 * It will use `Vue_router.set` on all keys of the new data. So it's better
...
/**
 * Create a fresh instance of Vue_router for each Weex instance.
 */
function createVueModuleInstance (instanceId, moduleGetter) {
  ...
  // Hack `Vue_router` behavior to handle instance information and data
